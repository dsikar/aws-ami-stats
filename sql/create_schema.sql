...
DELIMITER %%
CREATE PROCEDURE uspInsertImage(arch VARCHAR(6), cd char(24), hv char(3), ii varchar(21), it varchar(7), iname varchar(120), ownid varchar(18), rdt varchar(14), vt varchar(11),  pc varchar(50), rg varchar(14))
BEGIN
	...
	VALUES (arch, cd, hv, ii, it, iname, ownid, rdt, vt, pc, rc);
